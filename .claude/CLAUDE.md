...
Go CLI that orchestrates multi-team AI agent workflows. Reads `orchestra.yaml`, builds a DAG (Kahn's algorithm), and spawns `claude -p` subprocesses per team lead — parallel within a tier, sequential across tiers.
